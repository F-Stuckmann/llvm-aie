...
; CHECK-NEXT:    [[CONV2:%.*]] = sext i16 [[TMP0]] to i32
; CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr [[N_ADDR]], align 2
; CHECK-NEXT:    [[CONV13:%.*]] = sext i16 [[TMP1]] to i32
; CHECK-NEXT:    [[CMP4:%.*]] = icmp slt i32 [[CONV2]], [[CONV13]]
...
; CHECK-NEXT:    [[TMP8:%.*]] = load i16, ptr [[I]], align 2
; CHECK-NEXT:    [[CONV:%.*]] = sext i16 [[TMP8]] to i32
; CHECK-NEXT:    [[TMP9:%.*]] = load i16, ptr [[N_ADDR]], align 2
; CHECK-NEXT:    [[CONV1:%.*]] = sext i16 [[TMP9]] to i32
; CHECK-NEXT:    [[CMP:%.*]] = icmp slt i32 [[CONV]], [[CONV1]]
; CHECK-NEXT:    br i1 [[CMP]], label [[FOR_BODY]], label [[FOR_COND_FOR_END_CRIT_EDGE:%.*]], !llvm.loop [[LOOP0]]
; CHECK:       for.cond.for.end_crit_edge:
; CHECK-NEXT:    br label [[FOR_END]]
; CHECK:       for.end:
; CHECK-NEXT:    ret void
...
; CHECK:       for.cond:
; CHECK-NEXT:    [[I_0:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[ADD:%.*]], [[FOR_COND]] ]
...
; CHECK-NEXT:    br i1 [[CMP]], label [[FOR_COND]], label [[FOR_COND_CLEANUP:%.*]], !llvm.loop [[LOOP4]]
