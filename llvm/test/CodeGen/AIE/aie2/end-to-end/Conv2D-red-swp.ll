...
; DCL-NEXT:    paddb [sp], #256
; DCL-NEXT:    st p6, [sp, #-256] // 4-byte Folded Spill
; DCL-NEXT:    mov p6, sp
...
; DCL-NEXT:    lda dn7, [p6, #-4]; st dj3, [sp, #-220] // 4-byte Folded Spill
; DCL-NEXT:    lda dj7, [p6, #0]; st dc7, [sp, #-224] // 4-byte Folded Spill
; DCL-NEXT:    mov dj5, r14
; DCL-NEXT:    mov m2, r24
; DCL-NEXT:    mov dn5, r15
; DCL-NEXT:    mov m3, r25
; DCL-NEXT:    st m7, [sp, #-236] // 4-byte Folded Spill
; DCL-NEXT:    st dn7, [sp, #-232] // 4-byte Folded Spill
; DCL-NEXT:    mova r9, #31; st dj7, [sp, #-228]; movx r8, #11 // 4-byte Folded Spill
...
; DCL-NEXT:    lda m7, [sp, #-236]; nopx // 4-byte Folded Reload
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    lda dn7, [sp, #-232] // 4-byte Folded Reload
; DCL-NEXT:    vlda.ups.s32.s16 bmh0, s0, [p2, #32]
; DCL-NEXT:    vlda.ups.s32.s16 bml0, s0, [p2], m5; st m7, [sp, #-252] // 4-byte Folded Spill
; DCL-NEXT:    vlda.ups.s32.s16 bmh1, s0, [p2, #32]; mov m7, p5
; DCL-NEXT:    vlda.ups.s32.s16 bml1, s0, [p2], m7
; DCL-NEXT:    vlda.ups.s32.s16 bmh2, s0, [p2, #32]; vldb wl3, [p0], m6; mov r0, p0
; DCL-NEXT:    vlda.ups.s32.s16 bml2, s0, [p2], m5; vldb wh3, [p0], m6
; DCL-NEXT:    vlda.ups.s32.s16 bmh3, s0, [p2, #32]; vldb wl7, [p0], m6; mov m1, r11
; DCL-NEXT:    vlda.ups.s32.s16 bml3, s0, [p2], m1; vldb.3d wh7, [p0], d0
; DCL-NEXT:    lda dj7, [sp, #-228] // 4-byte Folded Reload
; DCL-NEXT:    vlda.ups.s32.s16 bmh4, s0, [p2, #32]
; DCL-NEXT:    vlda.ups.s32.s16 bml4, s0, [p2], m5
; DCL-NEXT:    lda dc7, [sp, #-220]; and r0, r0, r9 // 4-byte Folded Reload
; DCL-NEXT:    vlda.ups.s32.s16 bmh7, s0, [p2, #32]; add r0, r0, #33
; DCL-NEXT:    vlda.ups.s32.s16 bml7, s0, [p2], m7; vshift.align x4, x4, s1, x3, r0
; DCL-NEXT:    vlda.ups.s32.s16 bmh5, s0, [p2, #32]; vldb wl6, [p1], #32; vshift.align x2, x2, s1, x7, r0
; DCL-NEXT:    vlda.ups.s32.s16 bml5, s0, [p2], m5; vldb wh6, [p1], #32; vshuffle x7, x4, x2, r2
; DCL-NEXT:    vlda.ups.s32.s16 bmh6, s0, [p2, #32]; vldb wl5, [p0], m6; mov r1, p0
; DCL-NEXT:    vlda wl8, [p1], #32; vldb wh5, [p0], m6; mov r29, dc7
; DCL-NEXT:    vlda wh8, [p1], #32; vldb wl3, [p0], m6; vshuffle x9, x7, x0, r8
; DCL-NEXT:    vlda.ups.s32.s16 bml6, s0, [p2, #0]; vldb.3d wh3, [p0], d0; and r10, r1, r9
; DCL-NEXT:    st dn7, [sp, #-248]; vldb wl1, [p1], #32; add r1, r5, #-1 // 4-byte Folded Spill
; DCL-NEXT:    st dj7, [sp, #-244]; vldb wh1, [p1], #32; add r1, r1, #-1 // 4-byte Folded Spill
; DCL-NEXT:    vldb wl10, [p1], #32; add r0, r10, #33; mov r10, p0
; DCL-NEXT:    st dc7, [sp, #-240]; vldb wh10, [p1], #32; and r10, r10, r9 // 4-byte Folded Spill
...
; DCL-NEXT:    lda m7, [sp, #-252]; vst wl0, [sp, #-64] // 4-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    vlda wl11, [sp, #-64]; vst wh0, [sp, #-32] // 32-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    vlda wh11, [sp, #-32] // 32-byte Folded Reload
; DCL-NEXT:    vlda wl11, [sp, #-64] // 32-byte Folded Reload
; DCL-NEXT:    vlda wh11, [sp, #-32] // 32-byte Folded Reload
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    lda dn7, [sp, #-248]; vst wl11, [sp, #-128] // 4-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    lda dj7, [sp, #-244]; vst wh11, [sp, #-96]; vshuffle x0, x4, x2, r3 // 4-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    lda dc7, [sp, #-240]; st m7, [sp, #-236]; vshuffle x11, x0, x11, r8 // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda m7, [sp, #-236]; vmac cm0, cm0, x7, x6, r4 // 4-byte Folded Reload
; DCL-NEXT:    vlda wl0, [sp, #-128]; vst wl11, [sp, #-192]; vmac cm1, cm1, x9, x6, r4 // 32-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    vlda wl11, [sp, #-192]; vst wh11, [sp, #-160]; vmac cm8, cm4, x7, x8, r4 // 32-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    vlda wh11, [sp, #-160]; vmac cm4, cm7, x9, x8, r4 // 32-byte Folded Reload
; DCL-NEXT:    vlda wl6, [sp, #-192]; vmac cm2, cm2, x0, x6, r4 // 32-byte Folded Reload
; DCL-NEXT:    vlda wh6, [sp, #-160]; vmac cm5, cm5, x0, x8, r4 // 32-byte Folded Reload
; DCL-NEXT:    vlda wh0, [sp, #-96]; st dn7, [sp, #-232] // 32-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda dn7, [sp, #-232]; st dc7, [sp, #-224] // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    st dj7, [sp, #-228] // 4-byte Folded Spill
; DCL-NEXT:    lda dj7, [sp, #-228]; st dc7, [sp, #-220]; vshift.align x4, x4, s1, x5, r0 // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    vshift.align x2, x2, s1, x3, r0; vmac cm3, cm3, x11, x6, r4
; DCL-NEXT:    st m7, [sp, #-236]; vshuffle x6, x4, x2, r2 // 4-byte Folded Spill
...
; DCL-NEXT:    lda dc7, [sp, #-220]; vst.srs.s16.s32 bmh2, s3, [p3, #32]; mov m1, r26 // 4-byte Folded Reload
...
; ZOL-NEXT:    lda dn7, [p6, #-4]; st dj3, [sp, #-220] // 4-byte Folded Spill
; ZOL-NEXT:    lda dj7, [p6, #0]; st dc7, [sp, #-224] // 4-byte Folded Spill
; ZOL-NEXT:    mov dj5, r13
; ZOL-NEXT:    mov m2, r15
; ZOL-NEXT:    mov dn5, r14
; ZOL-NEXT:    mov m3, r24
; ZOL-NEXT:    st m7, [sp, #-236] // 4-byte Folded Spill
; ZOL-NEXT:    st dn7, [sp, #-232] // 4-byte Folded Spill
; ZOL-NEXT:    mova r9, #31; st dj7, [sp, #-228]; movx r8, #11 // 4-byte Folded Spill
...
; ZOL-NEXT:    lda m7, [sp, #-236]; nopb ; nopx // 4-byte Folded Reload
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    lda dn7, [sp, #-232] // 4-byte Folded Reload
; ZOL-NEXT:    vlda.ups.s32.s16 bmh0, s0, [p2, #32]
; ZOL-NEXT:    vlda.ups.s32.s16 bml0, s0, [p2], m5; st m7, [sp, #-252] // 4-byte Folded Spill
; ZOL-NEXT:    vlda.ups.s32.s16 bmh1, s0, [p2, #32]; mov m7, p5
; ZOL-NEXT:    vlda.ups.s32.s16 bml1, s0, [p2], m7
; ZOL-NEXT:    vlda.ups.s32.s16 bmh2, s0, [p2, #32]; vldb wl3, [p0], m6; mov r0, p0
; ZOL-NEXT:    vlda.ups.s32.s16 bml2, s0, [p2], m5; vldb wh3, [p0], m6
; ZOL-NEXT:    vlda.ups.s32.s16 bmh3, s0, [p2, #32]; vldb wl7, [p0], m6; mov m1, r10
; ZOL-NEXT:    vlda.ups.s32.s16 bml3, s0, [p2], m1; vldb.3d wh7, [p0], d0
; ZOL-NEXT:    lda dj7, [sp, #-228] // 4-byte Folded Reload
; ZOL-NEXT:    vlda.ups.s32.s16 bmh4, s0, [p2, #32]
; ZOL-NEXT:    vlda.ups.s32.s16 bml4, s0, [p2], m5
; ZOL-NEXT:    lda dc7, [sp, #-220]; and r0, r0, r9 // 4-byte Folded Reload
; ZOL-NEXT:    vlda.ups.s32.s16 bmh7, s0, [p2, #32]; add r0, r0, #33; mov r1, p0
; ZOL-NEXT:    vlda.ups.s32.s16 bml7, s0, [p2], m7; vldb wl6, [p1], #32; vshift.align x4, x4, s1, x3, r0
; ZOL-NEXT:    vlda.ups.s32.s16 bmh5, s0, [p2, #32]; vldb wh6, [p1], #32; vshift.align x2, x2, s1, x7, r0
; ZOL-NEXT:    vlda.ups.s32.s16 bml5, s0, [p2], m5; vldb wl5, [p0], m6; vshuffle x7, x4, x2, r2
; ZOL-NEXT:    vlda.ups.s32.s16 bmh6, s0, [p2, #32]; vldb wh5, [p0], m6
; ZOL-NEXT:    vlda wl8, [p1], #32; vldb wl3, [p0], m6; mov r28, dc7
; ZOL-NEXT:    vlda wh8, [p1], #32; vldb.3d wh3, [p0], d0; vshuffle x9, x7, x0, r8
; ZOL-NEXT:    vlda.ups.s32.s16 bml6, s0, [p2, #0]; vldb wl1, [p1], #32; movxm ls, #.LBB0_2
; ZOL-NEXT:    st dn7, [sp, #-248]; vldb wh1, [p1], #32; movxm le, #.L_LEnd0 // 4-byte Folded Spill
; ZOL-NEXT:    st dj7, [sp, #-244]; vldb wl10, [p1], #32; and r1, r1, r9 // 4-byte Folded Spill
; ZOL-NEXT:    vldb wh10, [p1], #32; add r0, r1, #33; mov r1, p0
; ZOL-NEXT:    st dc7, [sp, #-240]; and r1, r1, r9; add.nc lc, r5, #-2 // 4-byte Folded Spill
...
; ZOL-NEXT:    lda m7, [sp, #-252]; nopb ; nopx ; vst wl0, [sp, #-64] // 4-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    vlda wl11, [sp, #-64]; vst wh0, [sp, #-32] // 32-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    vlda wh11, [sp, #-32] // 32-byte Folded Reload
; ZOL-NEXT:    vlda wl11, [sp, #-64] // 32-byte Folded Reload
; ZOL-NEXT:    vlda wh11, [sp, #-32] // 32-byte Folded Reload
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    lda dn7, [sp, #-248]; vst wl11, [sp, #-128] // 4-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    lda dj7, [sp, #-244]; vst wh11, [sp, #-96]; vshuffle x0, x4, x2, r3 // 4-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    lda dc7, [sp, #-240]; st m7, [sp, #-236]; vshuffle x11, x0, x11, r8 // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda m7, [sp, #-236]; vmac cm0, cm0, x7, x6, r4 // 4-byte Folded Reload
; ZOL-NEXT:    vlda wl0, [sp, #-128]; vst wl11, [sp, #-192]; vmac cm1, cm1, x9, x6, r4 // 32-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    vlda wl11, [sp, #-192]; vst wh11, [sp, #-160]; vmac cm8, cm4, x7, x8, r4 // 32-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    vlda wh11, [sp, #-160]; vmac cm4, cm7, x9, x8, r4 // 32-byte Folded Reload
; ZOL-NEXT:    vlda wl6, [sp, #-192]; vmac cm2, cm2, x0, x6, r4 // 32-byte Folded Reload
; ZOL-NEXT:    vlda wh6, [sp, #-160]; vmac cm5, cm5, x0, x8, r4 // 32-byte Folded Reload
; ZOL-NEXT:    vlda wh0, [sp, #-96]; st dn7, [sp, #-232] // 32-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda dn7, [sp, #-232]; st dc7, [sp, #-224] // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    st dj7, [sp, #-228] // 4-byte Folded Spill
; ZOL-NEXT:    lda dj7, [sp, #-228]; st dc7, [sp, #-220]; vshift.align x4, x4, s1, x5, r0 // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    vshift.align x2, x2, s1, x3, r0; vmac cm3, cm3, x11, x6, r4
; ZOL-NEXT:    st m7, [sp, #-236]; vshuffle x6, x4, x2, r2 // 4-byte Folded Spill
...
; ZOL-NEXT:    lda dc7, [sp, #-220]; vst.srs.s16.s32 bmh2, s3, [p3, #32]; mov m1, r25 // 4-byte Folded Reload
