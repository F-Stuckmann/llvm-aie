...
; DCL-NEXT:    lda dn7, [p6, #-4]; st dj3, [sp, #-96] // 4-byte Folded Spill
; DCL-NEXT:    lda dj7, [p6, #0]; st dc7, [sp, #-148] // 4-byte Folded Spill
; DCL-NEXT:    mov dj5, r14
; DCL-NEXT:    mov m2, r24
; DCL-NEXT:    mov dn5, r15
; DCL-NEXT:    mov m3, r25
; DCL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; DCL-NEXT:    st dn7, [sp, #-156] // 4-byte Folded Spill
; DCL-NEXT:    mova r9, #31; st dj7, [sp, #-152]; movx r8, #11 // 4-byte Folded Spill
...
; DCL-NEXT:    lda m7, [sp, #-160]; nopb ; nopxm ; nops // 4-byte Folded Reload
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    nop
; DCL-NEXT:    lda dj7, [sp, #-152] // 4-byte Folded Reload
; DCL-NEXT:    lda dn7, [sp, #-156] // 4-byte Folded Reload
; DCL-NEXT:    lda dc7, [sp, #-96]; st m7, [sp, #-160] // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda m7, [sp, #-160] // 4-byte Folded Reload
; DCL-NEXT:    nop
; DCL-NEXT:    mov r29, dc7
; DCL-NEXT:    vlda.ups.s32.s16 bmh0, s0, [p2, #32]; vldb wl3, [p0], m6; mov r0, p0
; DCL-NEXT:    vlda.ups.s32.s16 bml0, s0, [p2], m5; vldb wh3, [p0], m6; st dj7, [sp, #-152] // 4-byte Folded Spill
; DCL-NEXT:    vlda.ups.s32.s16 bmh1, s0, [p2, #32]; vldb wl7, [p0], m6; st dn7, [sp, #-156] // 4-byte Folded Spill
; DCL-NEXT:    lda dn7, [sp, #-156]; vldb.3d wh7, [p0], d0; st dc7, [sp, #-96] // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda dj7, [sp, #-152]; st m7, [sp, #-32] // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda dc7, [sp, #-96]; mov m7, p5 // 4-byte Folded Reload
...
; DCL-NEXT:    vlda.ups.s32.s16 bmh4, s0, [p2, #32]; st dc7, [sp, #-148]; vshuffle x7, x4, x2, r2 // 4-byte Folded Spill
...
; DCL-NEXT:    st dn7, [sp, #-28]; vldb wh1, [p1], #32; add r1, r5, #-1 // 4-byte Folded Spill
; DCL-NEXT:    st dj7, [sp, #-24]; vldb wl10, [p1], #32; add r1, r1, #-1 // 4-byte Folded Spill
; DCL-NEXT:    st dc7, [sp, #-20]; vldb wh10, [p1], #32; and r10, r10, r9 // 4-byte Folded Spill
...
; DCL-NEXT:    vmov x11, x0
; DCL-NEXT:    vshuffle x0, x4, x2, r3
; DCL-NEXT:    lda dn7, [sp, #-28]; vst wl11, [sp, #-96]; vshuffle x11, x0, x11, r8 // 4-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    lda dc7, [sp, #-20]; vst wh11, [sp, #-64] // 4-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    lda m7, [sp, #-32]; vst wl11, [sp, #-160] // 4-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    vlda wl11, [sp, #-160]; vst wh11, [sp, #-128]; vmac cm0, cm0, x7, x6, r4 // 32-byte Folded Reload32-byte Folded Spill
; DCL-NEXT:    vlda wh11, [sp, #-128]; vmac cm1, cm1, x9, x6, r4 // 32-byte Folded Reload
; DCL-NEXT:    lda dj7, [sp, #-24]; vmac cm8, cm4, x7, x8, r4 // 4-byte Folded Reload
; DCL-NEXT:    vlda wl0, [sp, #-96]; vmac cm4, cm7, x9, x8, r4 // 32-byte Folded Reload
; DCL-NEXT:    vlda wl6, [sp, #-160]; vmac cm2, cm2, x0, x6, r4 // 32-byte Folded Reload
; DCL-NEXT:    vlda wh6, [sp, #-128]; st dc7, [sp, #-96] // 32-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda dc7, [sp, #-96]; vmac cm5, cm5, x0, x8, r4 // 4-byte Folded Reload
; DCL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; DCL-NEXT:    lda m7, [sp, #-160]; vmac cm3, cm3, x11, x6, r4 // 4-byte Folded Reload
; DCL-NEXT:    vlda wh0, [sp, #-64]; st dn7, [sp, #-156] // 32-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    lda dn7, [sp, #-156]; st dj7, [sp, #-152] // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    st dc7, [sp, #-148] // 4-byte Folded Spill
; DCL-NEXT:    lda dj7, [sp, #-152]; vshift.align x4, x4, s1, x5, r0; vmac cm6, cm6, x6, x8, r4 // 4-byte Folded Reload
; DCL-NEXT:    st dc7, [sp, #-148]; vshift.align x2, x2, s1, x3, r0 // 4-byte Folded Spill
; DCL-NEXT:    st dc7, [sp, #-96]; vshuffle x6, x4, x2, r2 // 4-byte Folded Spill
; DCL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; DCL-NEXT:    vshuffle x8, x6, x0, r8; vmac cm7, cm0, x6, x1, r4
; DCL-NEXT:    st dn7, [sp, #-156] // 4-byte Folded Spill
; DCL-NEXT:    vshuffle x3, x4, x2, r3; vmac cm0, cm1, x8, x1, r4
; DCL-NEXT:    st dj7, [sp, #-152] // 4-byte Folded Spill
...
; DCL-NEXT:    lda m7, [sp, #-160]; vst.srs.s16.s32 bml0, s3, [p3], m4 // 4-byte Folded Reload
; DCL-NEXT:    lda dn7, [sp, #-156]; vst.srs.s16.s32 bmh1, s3, [p3, #32] // 4-byte Folded Reload
; DCL-NEXT:    lda dj7, [sp, #-152]; vst.srs.s16.s32 bml1, s3, [p3], #64 // 4-byte Folded Reload
; DCL-NEXT:    vst.srs.s16.s32 bmh2, s3, [p3, #32]; mov m1, r26
; DCL-NEXT:    vst.srs.s16.s32 bml2, s3, [p3], m1; vmac cm5, cm5, x3, x10, r4
; DCL-NEXT:    vmac cm3, cm8, x6, x10, r4
; DCL-NEXT:    vmac cm8, cm4, x8, x10, r4
; DCL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; DCL-NEXT:    lda dc7, [sp, #-96]; st dn7, [sp, #-156] // 4-byte Folded Reload4-byte Folded Spill
; DCL-NEXT:    st dj7, [sp, #-152] // 4-byte Folded Spill
...
; DCL-NEXT:    st dc7, [sp, #-148] // 4-byte Folded Spill Delay Slot 4
; DCL-NEXT:    st dc7, [sp, #-96] // 4-byte Folded Spill Delay Slot 3
...
; ZOL-NEXT:    lda dn7, [p6, #-4]; st dj3, [sp, #-96] // 4-byte Folded Spill
; ZOL-NEXT:    lda dj7, [p6, #0]; st dc7, [sp, #-148] // 4-byte Folded Spill
; ZOL-NEXT:    mov dj5, r13
; ZOL-NEXT:    mov m2, r15
; ZOL-NEXT:    mov dn5, r14
; ZOL-NEXT:    mov m3, r24
; ZOL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; ZOL-NEXT:    st dn7, [sp, #-156] // 4-byte Folded Spill
; ZOL-NEXT:    mova r9, #31; st dj7, [sp, #-152]; movx r8, #11 // 4-byte Folded Spill
...
; ZOL-NEXT:    nopb ; lda m7, [sp, #-160]; nops ; nopxm ; nopv // 4-byte Folded Reload
; ZOL-NEXT:    nopx
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    nop
; ZOL-NEXT:    lda dj7, [sp, #-152] // 4-byte Folded Reload
; ZOL-NEXT:    lda dn7, [sp, #-156] // 4-byte Folded Reload
; ZOL-NEXT:    lda dc7, [sp, #-96]; st m7, [sp, #-160] // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda m7, [sp, #-160] // 4-byte Folded Reload
; ZOL-NEXT:    nop
; ZOL-NEXT:    mov r28, dc7
; ZOL-NEXT:    vlda.ups.s32.s16 bmh0, s0, [p2, #32]; vldb wl3, [p0], m6; mov r0, p0
; ZOL-NEXT:    vlda.ups.s32.s16 bml0, s0, [p2], m5; vldb wh3, [p0], m6; st dj7, [sp, #-152] // 4-byte Folded Spill
; ZOL-NEXT:    vlda.ups.s32.s16 bmh1, s0, [p2, #32]; vldb wl7, [p0], m6; st dn7, [sp, #-156] // 4-byte Folded Spill
; ZOL-NEXT:    lda dn7, [sp, #-156]; vldb.3d wh7, [p0], d0; st dc7, [sp, #-96] // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda dj7, [sp, #-152]; st m7, [sp, #-32] // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda dc7, [sp, #-96]; mov m7, p5 // 4-byte Folded Reload
...
; ZOL-NEXT:    vlda.ups.s32.s16 bmh4, s0, [p2, #32]; st dc7, [sp, #-148]; vshuffle x7, x4, x2, r2 // 4-byte Folded Spill
...
; ZOL-NEXT:    st dn7, [sp, #-28]; vldb wl10, [p1], #32; movxm ls, #.LBB0_2 // 4-byte Folded Spill
; ZOL-NEXT:    st dj7, [sp, #-24]; vldb wh10, [p1], #32; movxm le, #.L_LEnd0 // 4-byte Folded Spill
; ZOL-NEXT:    st dc7, [sp, #-20]; and r1, r1, r9; add.nc lc, r5, #-2 // 4-byte Folded Spill
...
; ZOL-NEXT:    vmov x11, x0
; ZOL-NEXT:    vshuffle x0, x4, x2, r3
; ZOL-NEXT:    lda dn7, [sp, #-28]; vst wl11, [sp, #-96]; vshuffle x11, x0, x11, r8 // 4-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    lda dc7, [sp, #-20]; vst wh11, [sp, #-64] // 4-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    lda m7, [sp, #-32]; vst wl11, [sp, #-160] // 4-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    vlda wl11, [sp, #-160]; vst wh11, [sp, #-128]; vmac cm0, cm0, x7, x6, r4 // 32-byte Folded Reload32-byte Folded Spill
; ZOL-NEXT:    vlda wh11, [sp, #-128]; vmac cm1, cm1, x9, x6, r4 // 32-byte Folded Reload
; ZOL-NEXT:    lda dj7, [sp, #-24]; vmac cm8, cm4, x7, x8, r4 // 4-byte Folded Reload
; ZOL-NEXT:    vlda wl0, [sp, #-96]; vmac cm4, cm7, x9, x8, r4 // 32-byte Folded Reload
; ZOL-NEXT:    vlda wl6, [sp, #-160]; vmac cm2, cm2, x0, x6, r4 // 32-byte Folded Reload
; ZOL-NEXT:    vlda wh6, [sp, #-128]; st dc7, [sp, #-96] // 32-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda dc7, [sp, #-96]; vmac cm5, cm5, x0, x8, r4 // 4-byte Folded Reload
; ZOL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; ZOL-NEXT:    lda m7, [sp, #-160]; vmac cm3, cm3, x11, x6, r4 // 4-byte Folded Reload
; ZOL-NEXT:    vlda wh0, [sp, #-64]; st dn7, [sp, #-156] // 32-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    lda dn7, [sp, #-156]; st dj7, [sp, #-152] // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    st dc7, [sp, #-148] // 4-byte Folded Spill
; ZOL-NEXT:    lda dj7, [sp, #-152]; vshift.align x4, x4, s1, x5, r0; vmac cm6, cm6, x6, x8, r4 // 4-byte Folded Reload
; ZOL-NEXT:    st dc7, [sp, #-148]; vshift.align x2, x2, s1, x3, r0 // 4-byte Folded Spill
; ZOL-NEXT:    st dc7, [sp, #-96]; vshuffle x6, x4, x2, r2 // 4-byte Folded Spill
; ZOL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; ZOL-NEXT:    vshuffle x8, x6, x0, r8; vmac cm7, cm0, x6, x1, r4
; ZOL-NEXT:    st dn7, [sp, #-156] // 4-byte Folded Spill
; ZOL-NEXT:    vshuffle x3, x4, x2, r3; vmac cm0, cm1, x8, x1, r4
; ZOL-NEXT:    st dj7, [sp, #-152] // 4-byte Folded Spill
...
; ZOL-NEXT:    lda m7, [sp, #-160]; vst.srs.s16.s32 bml0, s3, [p3], m4 // 4-byte Folded Reload
; ZOL-NEXT:    lda dn7, [sp, #-156]; vst.srs.s16.s32 bmh1, s3, [p3, #32] // 4-byte Folded Reload
; ZOL-NEXT:    lda dj7, [sp, #-152]; vst.srs.s16.s32 bml1, s3, [p3], #64 // 4-byte Folded Reload
; ZOL-NEXT:    vst.srs.s16.s32 bmh2, s3, [p3, #32]; mov m1, r25
; ZOL-NEXT:    vst.srs.s16.s32 bml2, s3, [p3], m1; vmac cm5, cm5, x3, x10, r4
; ZOL-NEXT:    vmac cm3, cm8, x6, x10, r4
; ZOL-NEXT:    vmac cm8, cm4, x8, x10, r4
; ZOL-NEXT:    st m7, [sp, #-160] // 4-byte Folded Spill
; ZOL-NEXT:    lda dc7, [sp, #-96]; st dn7, [sp, #-156] // 4-byte Folded Reload4-byte Folded Spill
; ZOL-NEXT:    st dj7, [sp, #-152] // 4-byte Folded Spill
...
; ZOL-NEXT:    st dc7, [sp, #-148] // 4-byte Folded Spill Delay Slot 4
; ZOL-NEXT:    st dc7, [sp, #-96] // 4-byte Folded Spill Delay Slot 3
