; NOTE: Assertions have been autogenerated by utils/update_test_checks.py UTC_ARGS: --tool llc --function skip_split_full --version 5
...
; CHECK-NEXT: %a.ptr.next.steady.top = getelementptr inbounds i32, ptr %a, i32 1
; CHECK-NEXT: %b.ptr.next.steady.top = getelementptr inbounds i32, ptr %b, i32 1
; CHECK-NEXT: %c.ptr.next.steady.top = getelementptr inbounds i32, ptr %c, i32 1
...
; CHECK-NEXT: %a.ptr.steady = phi ptr [ %a.ptr.next.steady.phi, %steady.stage1.bottom.and.stage0.top ], [ %a, %stage0.top ]
; CHECK-NEXT: %b.ptr.steady = phi ptr [ %b.ptr.next.steady.phi, %steady.stage1.bottom.and.stage0.top ], [ %b, %stage0.top ]
; CHECK-NEXT: %c.ptr.steady = phi ptr [ %c.ptr.next.steady.phi, %steady.stage1.bottom.and.stage0.top ], [ %c, %stage0.top ]
...
; CHECK-NEXT: %a.ptr.next.steady.phi = phi ptr [ %a.ptr.next.steady.top, %stage0.top ], [ %a.ptr.next.steady.bottom, %steady.stage1.bottom.and.stage0.top ]
; CHECK-NEXT: %b.ptr.next.steady.phi = phi ptr [ %b.ptr.next.steady.top, %stage0.top ], [ %b.ptr.next.steady.bottom, %steady.stage1.bottom.and.stage0.top ]
; CHECK-NEXT: %c.ptr.next.steady.phi = phi ptr [ %c.ptr.next.steady.top, %stage0.top ], [ %c.ptr.next.steady.bottom, %steady.stage1.bottom.and.stage0.top ]
...
; CHECK-NEXT: %v0.steady.bottom = load i32, ptr %a.ptr.next.steady.phi, align 4
; CHECK-NEXT: %v1.steady.bottom = load i32, ptr %b.ptr.next.steady.phi, align 4
; CHECK-NEXT: %.bottom = mul i32 %v1.steady.bottom, %v0.steady.bottom
; CHECK-NEXT: %a.ptr.next.steady.bottom = getelementptr inbounds i32, ptr %a.ptr.next.steady.phi, i32 1
; CHECK-NEXT: %b.ptr.next.steady.bottom = getelementptr inbounds i32, ptr %b.ptr.next.steady.phi, i32 1
...
; CHECK-NEXT: store i32 %lsr.iv.next.lastiter, ptr %c.ptr.next.steady.phi, align 4
