...
TEST_F(AIEOuterLoopPipelinerTest,
  ...
  std::unique_ptr<Module> M = parseAssemblyString(R"IR(
    ...
    !3 = !{!"llvm.loop.itercount.range", i32 2}
    !4 = !{!"llvm.loop.hint.aie-enable-outer-loop-pipelining", i64 1}
    !5 = !{!"llvm.loop.hint.aie-outer-loop-pipelining-skip-split", i64 1}
  )IR",
                                                  Error, Context);
  ASSERT_TRUE(M) << Error.getMessage().str();
  ...
  ASSERT_NE(Stage0, nullptr);
  ASSERT_NE(Stage1, nullptr);
  ASSERT_NE(LastIteration, nullptr);
...
TEST_F(AIEOuterLoopPipelinerTest, SkipSplitOverridesOtherSplitOptions) {
  ...
  std::unique_ptr<Module> M = parseAssemblyString(R"IR(
    ...
    !0 = distinct !{!0, !2, !3, !4, !5, !6, !7}
    !1 = distinct !{!1, !2}
    !2 = !{!"llvm.loop.mustprogress"}
    !3 = !{!"llvm.loop.itercount.range", i32 2}
    !4 = !{!"llvm.loop.hint.aie-enable-outer-loop-pipelining", i64 1}
    !5 = !{!"llvm.loop.hint.aie-outer-loop-pipelining-skip-split", i64 1}
    !6 = !{!"llvm.loop.hint.aie-outer-loop-pipelining-lean-stage0", i64 1}
    !7 = !{!"llvm.loop.hint.aie-outer-loop-pipelining-speculative", i64 1}
  )IR",
                                                  Error, Context);
  ASSERT_TRUE(M) << Error.getMessage().str();
