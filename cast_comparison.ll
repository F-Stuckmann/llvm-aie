;===-- cast_comparison.ll - check type casting for assumption----*- IR-*-===//
;
...
define dso_local void @_Zi16toi32(i32 noundef %num_elems, i32 noundef %n, ptr nocapture %param) local_unnamed_addr #0 {

entry:
  %channel_loop_cnt = getelementptr inbounds i8, ptr %param, i20 38
  br label %for.cond

for.cond:                                         ; preds = %for.cond.cleanup10, %entry
  %c.0 = phi i16 [ 0, %entry ], [ %inc, %for.body ]
  %0 = load i16, ptr %channel_loop_cnt, align 2
  %cmp = icmp ult i16 %c.0, %0
